...
setInterval(async () => {
const statuses = [`.chat`, `Naitik.exe#3750`]
   client.user.setActivity(statuses[Math.floor(Math.random() * statuses.length)], { type: "STREAMING", url: "https://www.youtube.com/channel/UCt5FBx5YaZ7QZmd4sDEJYmw"})
}, 10000)
});
